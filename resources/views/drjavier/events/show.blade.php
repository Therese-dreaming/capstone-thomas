...
@section('title', 'Event Details - Dr. Javier')
...
@section('header-actions')
    <div class="flex items-center space-x-3">
        <a href="{{ route('drjavier.events.export', ['event_id' => $event->id]) }}" 
           class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition shadow-sm flex items-center">
            <i class="fas fa-file-excel mr-2"></i>Export Event
        </a>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div class="space-y-8">
            ...
            <div class="category-card animate-fadeIn">
                <div class="category-header">
                    <h2 class="text-xl font-bold text-gray-800 font-poppins flex items-center">
                        <i class="fas fa-download text-maroon mr-3 text-2xl"></i>
                        Export Options
                    </h2>
                </div>
                <div class="category-content">
                    <div class="space-y-3">
                        ...
                        <div class="text-xs text-gray-500 text-center">
                            ...
                            Export includes all event details and information
                        </div>
                    </div>
                </div>
            </div>
