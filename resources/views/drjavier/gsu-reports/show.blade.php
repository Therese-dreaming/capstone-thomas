...
@section('title', 'Report Details - OTP')
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center">
                                <i class="fas fa-tag text-indigo-600 mr-3 w-4"></i>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center">
                                <i class="fas fa-exclamation text-indigo-600 mr-3 w-4"></i>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center">
                                <i class="fas fa-info-circle text-indigo-600 mr-3 w-4"></i>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center">
                                <i class="fas fa-calendar text-indigo-600 mr-3 w-4"></i>
                ...
                @if($report->description)
                    <div class="mt-6 p-4 bg-gray-50 rounded-lg border-l-4 border-indigo-600">
                        <div class="flex items-start">
                            <i class="fas fa-file-alt text-indigo-600 mr-3 mt-0.5"></i>
                            <div>
        ...
        <div class="space-y-6">
                        ...
                        <form id="statusUpdateForm">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <select id="status" name="status" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200">
                                ...
                                <button type="submit" 
                                        class="w-full px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all duration-200 font-medium shadow-md hover:shadow-lg">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    ...
                    @if($report->reservation)
                        <a href="{{ route('drjavier.reservations.show', $report->reservation->id) }}" 
                    ...
                    @if($report->event)
                        <a href="{{ route('drjavier.events.show', $report->event->id) }}" 
                           class="w-full px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-200 font-medium shadow-md hover:shadow-lg flex items-center justify-center space-x-2 text-sm">
                            <i class="fas fa-eye mr-1.5"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    statusUpdateForm.addEventListener('submit', function(e) {
        ...
        fetch('{{ route("drjavier.gsu-reports.update-status", $report) }}', {
            method: 'POST',
            body: formData,
            headers: {
