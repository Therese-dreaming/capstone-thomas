...
<div class="space-y-6 font-inter animate-fadeIn">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            <div>
                ...
                <select name="type" id="type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200">
            ...
            <div>
                ...
                <select name="severity" id="severity" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200">
            ...
            <div>
                ...
                <select name="status" id="status" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200">
            ...
            <div class="flex items-end">
                <button type="submit" class="w-full px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all duration-200 font-medium shadow-md hover:shadow-lg">
                        ...
                        <div class="report-card rounded-lg p-6 hover:shadow-lg transition-all duration-300">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('drjavier.gsu-reports.show', $report) }}" 
                                       class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 transition-all duration-200 text-sm font-medium shadow-md hover:shadow-lg flex items-center space-x-2">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="space-y-2 text-sm text-gray-600">
                                        <div class="flex items-center">
                                            <i class="fas fa-exclamation-triangle mr-2 text-indigo-600 w-4"></i>
                                        ...
                                        <div class="flex items-center">
                                            <i class="fas fa-exclamation mr-2 text-indigo-600 w-4"></i>
                                        ...
                                        <div class="flex items-center">
                                            <i class="fas fa-calendar mr-2 text-indigo-600 w-4"></i>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="space-y-2 text-sm text-gray-600">
                                        <div class="flex items-center">
                                            <i class="fas fa-user mr-2 text-indigo-600 w-4"></i>
                                            <span class="font-medium">Name:</span>
                                            <span class="ml-1">{{ $report->reportedUser->name ?? 'N/A' }}</span>
                                        </div>
                                        <div class="flex items-center">
                                            <i class="fas fa-envelope mr-2 text-indigo-600 w-4"></i>
                                            <span class="font-medium">Email:</span>
                                            <span class="ml-1">{{ $report->reportedUser->email ?? 'N/A' }}</span>
                                        </div>
                                        <div class="flex items-center">
                                            <i class="fas fa-building mr-2 text-indigo-600 w-4"></i>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="space-y-2 text-sm text-gray-600">
                                        ...
                                        <div class="flex items-center">
                                            <i class="fas fa-badge mr-2 text-indigo-600 w-4"></i>
                                            <span class="font-medium">Role:</span>
                                            <span class="ml-1">GSU Staff</span>
                                        </div>
                                        <div class="flex items-center">
                                            <i class="fas fa-clock mr-2 text-indigo-600 w-4"></i>
    ...
    <div id="exportModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form id="exportForm" method="GET" action="{{ route('drjavier.gsu-reports.export') }}" class="p-6">
