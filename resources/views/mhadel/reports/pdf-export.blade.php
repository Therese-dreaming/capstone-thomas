...
<head>
    <meta charset="utf-8">
    <title>MS. MHADEL Reports Export</title>
    <style>
        @page {
            margin: 25mm 20mm;
        }
...
<body>
    ...
    <div class="header">
        ...
        <h1>MS. MHADEL REPORTS & ANALYTICS</h1>
        <p>
            @if($exportType === 'both')
    ...
    <!-- Footer -->
    <div class="footer">
        <p>MS. MHADEL Office of the President - Pasig Catholic College | Generated on {{ now()->format('F d, Y h:i A') }}</p>
    </div>
</body>
</html>
