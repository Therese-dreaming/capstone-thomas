    ...
    <div class="max-w-4xl mx-auto px-4 py-6">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            <div id="content-account" class="tab-content active">
                ...
                <form method="POST" action="{{ route('mhadel.profile.update') }}" class="space-y-6">
                    @csrf
                    @method('PUT')
            ...
            <div id="content-activity" class="tab-content">
                ...
                <div>
                    ...
                    @php
                        $recentReservations = \App\Models\Reservation::whereIn('status', ['approved_mhadel', 'rejected_mhadel'])
                                            ...
                                            @switch($reservation->status)
                                                ...
                                                @default
                                                    <span class="px-3 py-1 text-xs font-medium bg-yellow-100 text-yellow-800 rounded-full">
                                                        {{ ucfirst(str_replace('_mhadel', '', $reservation->status)) }}
                                                    </span>
                                            @endswitch
                                        </div>
                                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="{{ route('mhadel.dashboard') }}" class="group bg-gray-50 rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                    <div class="flex items-center">
                ...
                <a href="{{ route('mhadel.reservations.index') }}" class="group bg-gray-50 rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-maroon rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-200">
                            <i class="fas fa-calendar-alt text-white text-xl"></i>
                        </div>
                ...
                <a href="{{ route('mhadel.events.index') }}" class="group bg-gray-50 rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                    <div class="flex items-center">
                        <div class="w-12 h-12 bg-maroon rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-200">
