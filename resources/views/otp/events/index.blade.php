		...
		<div class="p-8 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
			<div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
				<div>
					...
					<p class="text-gray-600 text-lg">Monitor and view all events in the system</p>
				</div>
	...
	<div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
		<div class="p-6 border-b border-gray-200 bg-gray-50">
			...
			<div id="filtersContainer" class="hidden">
				<form method="GET" action="{{ route('drjavier.events.index') }}" class="space-y-4">
					...
					<div class="flex items-center justify-between pt-4 border-t border-gray-200">
						<div class="flex items-center space-x-3">
							...
							<a href="{{ route('drjavier.events.index') }}" class="bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 transition-all duration-200 font-medium shadow-md hover:shadow-lg flex items-center space-x-2 text-sm">
