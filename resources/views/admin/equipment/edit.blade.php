...
<div class="bg-white rounded-lg shadow-sm">
    <div class="p-6 border-b border-gray-200">
        ...
        <p class="text-gray-600 text-sm">Update the equipment details</p>
    </div>

    <form action="{{ route('admin.equipment.update', $equipment) }}" method="POST" class="p-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select name="category" 
                    ...
                    <option value="Audio" {{ old('category', $equipment->category) == 'Audio' ? 'selected' : '' }}>Audio</option>
                    <option value="Visual" {{ old('category', $equipment->category) == 'Visual' ? 'selected' : '' }}>Visual</option>
                    <option value="Lighting" {{ old('category', $equipment->category) == 'Lighting' ? 'selected' : '' }}>Lighting</option>
                    <option value="Furniture" {{ old('category', $equipment->category) == 'Furniture' ? 'selected' : '' }}>Furniture</option>
                    <option value="Technology" {{ old('category', $equipment->category) == 'Technology' ? 'selected' : '' }}>Technology</option>
                    <option value="Safety" {{ old('category', $equipment->category) == 'Safety' ? 'selected' : '' }}>Safety</option>
