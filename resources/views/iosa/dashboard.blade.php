...
<div class="space-y-6">
    <!-- Welcome Section -->
    <div class="bg-maroon to-red-700 rounded-xl p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold mb-2">Welcome, {{ auth()->user()->name }}!</h2>
                <p class="text-white-600">You are logged in as an IOSA Administrator. Manage venue reservation approvals here.</p>
            </div>
            <div class="text-right">
                <div class="text-3xl font-bold">{{ date('M d, Y') }}</div>
                <div class="text-white-600">{{ date('l') }}</div>
            </div>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="p-6">
                ...
                <div class="mt-4 text-center">
                    <a href="{{ route('iosa.reservations.index') }}" class="text-maroon hover:text-maroon-dark font-medium">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div class="p-6">
                <div class="grid grid-cols-2 gap-4">
                    <a href="{{ route('iosa.reservations.index') }}" class="flex flex-col items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
