        ...
        <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2">
                    <form method="GET" action="{{ route('iosa.reservations.index') }}" class="flex items-center space-x-2">
                        ...
                        @if(request('search'))
                            <a href="{{ route('iosa.reservations.index', request()->except('search')) }}" class="px-3 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors text-sm">
                        ...
                        <div class="reservation-card bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                            <div class="p-5 flex flex-col md:flex-row md:items-center md:justify-between">
                                <div class="flex-1">
                                    ...
                                    <div class="mb-1">
                                        <h3 class="text-lg font-semibold text-gray-800">{{ $reservation->event_title }}</h3>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select id="filterVenue" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-maroon">
                            ...
                            @php
                                $uniqueVenues = $reservations->pluck('venue.name')->filter()->unique()->sort();
                            @endphp
                    ...
                    <div>
                        ...
                        <select id="filterDepartment" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-maroon focus:border-maroon">
                            ...
                            @php
                                $uniqueDepartments = $reservations->pluck('department')->filter()->unique()->sort();
                            @endphp
