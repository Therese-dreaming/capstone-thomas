                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('mhadel.reservations.index') }}"
                           class="flex items-center p-3 rounded-lg sidebar-transition {{ request()->routeIs('mhadel.reservations.index') || request()->routeIs('mhadel.reservations.show') || request()->routeIs('mhadel.reservations.edit') ? 'nav-active' : '' }}">
                                        ...
                                        @php
                                            ...
                                            if ($n->related_id && $n->related_type) {
                                                ...
                                                if ($n->related_type === 'App\Models\Event' || $n->related_type === 'Event') {
                                                    // Event-related notifications - Mhadel users go to mhadel.events.show
                                                    ...
                                                    // Reservation-related notifications - Mhadel users go to mhadel.reservations.show
