...
class EventsExport implements WithMultipleSheets
{
    ...
    {
        return [
            new EventsDataSheet($this->events),
            new EventsSummarySheet($this->events),
        ];
    }
}

// Data Sheet Class
class EventsDataSheet implements FromCollection, WithHeadings, WithMapping, WithColumnWidths, WithStyles, WithEvents, WithTitle
{
    protected $events;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Set title
                $sheet->setCellValue('A1', 'OTP EVENTS MANAGEMENT SYSTEM - DATA EXPORT');
...
// Summary Sheet Class
class EventsSummarySheet implements FromCollection, WithHeadings, WithColumnWidths, WithStyles, WithEvents, WithTitle
{
    protected $events;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Set title
                $sheet->setCellValue('A1', 'OTP EVENTS - SUMMARY REPORT');
                $sheet->getStyle('A1')->applyFromArray([
                    'font' => [
                        'bold' => true, 
                        'size' => 18, 
