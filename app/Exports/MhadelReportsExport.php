...
class MhadelReportsExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithColumnWidths, WithStyles, WithEvents, WithColumnFormatting, WithMultipleSheets
{
    protected $filters;
    ...
    public function collection()
    {
        ...
        // Order by oldest start date first (ascending)
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Title styling
                $sheet->setCellValue('A1', 'MS. MHADEL REPORTS & ANALYTICS');
                ...
                $sheet->getHeaderFooter()->setOddHeader('&C&HMS. MHADEL REPORTS & ANALYTICS');
    ...
    public function sheets(): array
    {
        return [
            'Reports' => $this,
            'Summary' => new MhadelSummarySheet($this->filters)
        ];
    }
} 