...
class MhadelCombinedExport implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new MhadelCombinedDataSheet($this->reservations, $this->events);

        if ($this->includeSummary) {
            $sheets[] = new MhadelSummarySheetNew($this->reservations, $this->events);
        }
...
class MhadelCombinedDataSheet implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithColumnWidths, WithStyles, WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'MS. MHADEL COMBINED REPORTS & ANALYTICS');
                ...
                $sheet->getHeaderFooter()->setOddHeader('&C&HMS. MHADEL COMBINED REPORTS & ANALYTICS');
...
class MhadelSummarySheetNew implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithColumnWidths, WithStyles, WithEvents
{
    protected $reservations;
    protected $events;
