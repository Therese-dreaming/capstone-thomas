...
class DrJavierReservationsExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithColumnWidths, WithStyles, WithEvents, WithColumnFormatting
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Title styling
                $sheet->setCellValue('A1', 'DR. JAVIER RESERVATION REPORTS & ANALYTICS');
                ...
                // Enable text wrapping for purpose column (C)
                $sheet->getStyle('C4:C' . $highestRow)->getAlignment()->setWrapText(true);
                
                // Set row height for purpose column to accommodate wrapped text
                ...
                $sheet->getHeaderFooter()->setOddHeader('&C&HDR. JAVIER RESERVATION REPORTS & ANALYTICS');
