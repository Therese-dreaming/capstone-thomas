...
class GSUCombinedExport implements WithMultipleSheets
{
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new GSUCombinedDataSheet($this->reservations, $this->events);

        if ($this->includeSummary) {
            $sheets[] = new GSUSummarySheetNew($this->reservations, $this->events);
        }
...
class GSUCombinedDataSheet implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithColumnWidths, WithStyles, WithEvents
{
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->setCellValue('A1', 'GSU COMBINED REPORTS - RESERVATIONS & EVENTS');
                ...
                $sheet->getHeaderFooter()->setOddHeader('&C&HGSU COMBINED REPORTS & ANALYTICS');
...
class GSUSummarySheetNew implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithColumnWidths, WithStyles, WithEvents
{
    protected $reservations;
    protected $events;
